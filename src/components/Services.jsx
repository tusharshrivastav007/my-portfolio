      ...
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <TagCard 
            number="01"
            title="Architect"
            text="Analyzing system requirements, scaling needs, and security constraints to design a resilient cloud architecture."
          ...
          <TagCard 
            number="02"
            title="Provision"
            text="Implementing Infrastructure as Code (IaC) using Terraform to ensure repeatable and consistent environments."
          ...
          <TagCard 
            number="03"
            title="Automate"
            text="Developing robust CI/CD pipelines, containerizing applications, and setting up GitOps workflows."
          ...
          <TagCard 
            number="04"
            title="Monitor & Scale"
            text="Establishing comprehensive observability and enforcing security policies for zero-downtime operations."
