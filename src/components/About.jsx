      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-start gap-14 md:gap-20">
          ...
          <div data-aos="fade-right" className="flex-shrink-0">
            <div className="relative w-52 md:w-64 rounded-2xl overflow-hidden border border-neutral-800 shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
              <img src={profilePhoto} alt="Tushar Shrivastav" className="w-full h-full object-cover object-top" />
          ...
          <div data-aos="fade-left" data-aos-delay="150" className="flex-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 mb-10">
              {[
                ...
                { label: 'LinkedIn',  value: 'linkedin.com/in/tusharshrivastav007' },
                { label: 'GitLab',    value: 'gitlab.com/tusharshrivastav' },
