    ...
    <AnimatePresence>
      {isLoading && (
        <motion.div
          ...
          className="fixed inset-0 w-full h-screen bg-[#07070a] z-[100000] flex items-center justify-center"
        >
          {/* Logo Container */}
          <motion.div 
          ...
          >
            ...
            <div className="text-neutral-800">
              Tushar Shrivastav<span className="text-neutral-800">.</span>
            </div>
            ...
            >
              Tushar Shrivastav<span className="text-red-500">.</span>
            </motion.div>
          </motion.div>
